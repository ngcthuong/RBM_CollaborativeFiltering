%% 초기화 하자
function [visHid, hidBiases, visBiases, allErr, allRMSE] = RBM_CF_Training_Batch2(batchdata, validate_data,  para, opts, file_name)
...
for epoch = 1:para.maxepoch
    ...
    for batch = 1 : para.numBatches         
        ...
        tmp    = zeros(size(visHid));              % Averaging of each probability  
        for i = 1:1:5
