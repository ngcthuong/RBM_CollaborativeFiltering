%% 초기화 하자
function [visHid, hidBiases, visBiases, allErr] = RBM_CF_Training(batchdata, opts)
...
batchIndex = size(batchdata, 4);   % fixed
ii = 1;
...
for epoch = opts.epoch:opts.maxepoch
    errsum = 0;
